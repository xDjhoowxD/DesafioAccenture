...
public class SendQuoteFuncionality extends BaseTest {
    ...
    public void preencherSendQuote(){
        ...
        if(this.sendQuotePage.getEmail().isEnabled()){
            ...
            this.utils.preencheCampoTexto(this.sendQuotePage.getEmail(),"jhonatansp1996@gmail.com");
        ...
        if(this.sendQuotePage.getUserName().isEnabled()){
            ...
            this.utils.preencheCampoTexto(this.sendQuotePage.getUserName(),"Jhonatan1996");
        ...
        if(this.sendQuotePage.getPassWord().isEnabled()){
            ...
            this.utils.preencheCampoTexto(this.sendQuotePage.getPassWord(),"Jhonatan123456");
        ...
        if(this.sendQuotePage.getConfirmPassWord().isEnabled()){
            ...
            this.utils.preencheCampoTexto(this.sendQuotePage.getConfirmPassWord(),"Jhonatan123456");
