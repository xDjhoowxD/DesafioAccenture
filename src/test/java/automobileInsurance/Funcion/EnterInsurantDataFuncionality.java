...
public class EnterInsurantDataFuncionality extends BaseTest {
    ...
    public void preencherEnterInsurantData(){
        ...
        if(this.enterInsurantDataPage.getFirstName().isEnabled()){
            ...
            this.utils.preencheCampoTexto(this.enterInsurantDataPage.getFirstName(), "Jhonatan");
        ...
        if(this.enterInsurantDataPage.getLastName().isEnabled()){
            ...
            this.utils.preencheCampoTexto(this.enterInsurantDataPage.getLastName(),"Pereira");
        ...
        if(this.enterInsurantDataPage.getDateOfBirth().isEnabled()){
            ...
            this.utils.preencheCampoTexto(this.enterInsurantDataPage.getDateOfBirth(),"04/05/1996");
        ...
        if(this.enterInsurantDataPage.getStreetAddress().isEnabled()){
            ...
            this.utils.preencheCampoTexto(this.enterInsurantDataPage.getStreetAddress(),"Rua Padre Eustáquio");
        ...
        if(this.enterInsurantDataPage.getZipCode().isEnabled()){
            ...
            this.utils.preencheCampoTexto(this.enterInsurantDataPage.getZipCode(),"08560500");
        ...
        if(this.enterInsurantDataPage.getCity().isEnabled()){
            ...
            this.utils.preencheCampoTexto(this.enterInsurantDataPage.getCity(),"Poa¡");
        ...
        if(this.enterInsurantDataPage.getSelectOccupation().isEnabled()){
            ...
            this.utils.selectByValue(this.enterInsurantDataPage.getSelectOccupation(),"Unemployed");
